...
function TaskCard2({ toDoList, deleteFunction }) {
  return (
    <div className="bg-green-400  w-1/3 h-[300px] overflow-y-scroll border border-black">
      <h1 className="text-center font-bold m-4 text-xl">Low priority tasks</h1>
