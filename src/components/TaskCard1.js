...
function TaskCard1({ toDoList, deleteFunction }) {
  return (
    <div className="bg-yellow-400  w-1/3 h-[300px] overflow-y-scroll border border-black">
      <h1 className="text-center font-bold m-4 text-xl">
